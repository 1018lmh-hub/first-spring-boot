...
public class JwtFilter extends OncePerRequestFilter{
	...
	// 요 안에서 반환하는 경로들을 필터를 아예 안타게 해주는 메소드
	@Override
...
//		log.info("이거 어케 옴: {}", authorization);
...
//			log.info("유저 디테일즈 : {}", user);
			...
			//세부설정 관련들 사용자의 IP주소, MAC주소, sessionId등을 포함시켜 셋팅
			SecurityContextHolder.getContext().setAuthentication(authentication);
			//요렇게 담아주면 현재 요청이 만료될 때까지 Authentication에 담겨있는 사용자의 정보를 사용할 수 있음
